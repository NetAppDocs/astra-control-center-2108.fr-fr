...
.Étapes
. Cliquez sur *compte > informations d'identification*.
. Cliquez sur la liste déroulante de la colonne *État* pour les informations d'identification que vous souhaitez supprimer.
. Cliquez sur *Supprimer*.
+
image:screenshot-remove-credentials.gif["Capture d'écran de l'onglet informations d'identification de la page compte dans laquelle vous pouvez cliquer sur la colonne État et sélectionner l'action Supprimer."]

. Tapez le mot "supprimer" pour confirmer la suppression, puis cliquez sur *Oui, Supprimer les informations d'identification*.
